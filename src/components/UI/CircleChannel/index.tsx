      ...
      <Link href={href} passHref>
        <div
          className={clsx({
            ...
            "rounded-2xl before:h-40 before:w-4": isActive,
            "hover:before:w-4 hover:before:h-[18px]": !isActive,
            "bg-purple": isActive && !imgUrl,
            "bg-gray-600 hover:bg-purple": !isActive && !imgUrl,
            "before:w-0 before:h-0": !isActive && !notification,
          })}
        >
          <svg
